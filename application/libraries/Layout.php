...
class Layout
{
    ...
    function view($view, $data=null, $title='', $return=false)
    {
        ...
        $data['_is_logged_in_'] = $loadedData['_is_logged_in_'] = $this->obj->user_model->isLoggedIn();
        $data['_is_new_user_'] = $this->obj->user_model->isNewUser();
        $data['_flash_'] = $this->obj->user_model->getFlash();
